<p align="center">
    <img src="./images/icons/python.PNG" alt="Python programming language logo." style="float: left;" width: 386>
    <img src="./images/icons/spark-logo-hd.png" alt="Spark logo." style="float: right;" width: 386>
</p>
